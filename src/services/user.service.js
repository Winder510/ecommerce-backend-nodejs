...
import { emailRemindChangePassWord, emailSendToken } from './email.service.js';
import { checkEmailToken } from './otp.service.js';
import { createUserRepo, findByEmail } from '../models/repositories/user.repository.js';
import { getInfoData, getUsernameFromEmail } from '../utils/index.js';
import { createTokenPair } from '../auth/authUtils.js';
import KeyTokenService from './keyToken.service.js';
const newUserService = async ({ email = null }) => {
...
const checkLoginEmailTokenService = async ({ token, res }) => {
...
const changePassWordService = async ({ email, currentPassword, newPassword, reNewPassword }) => {
...
export { newUserService, checkLoginEmailTokenService, changePassWordService };
